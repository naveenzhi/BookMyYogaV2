...
namespace Nop.Web.Models.Customer
{
    ...
    public partial class RegisterModel : BaseNopModel
    {
        ...
        [AllowHtml]
        [RegularExpression(@"^([A-Za-z ]{0,20})$", ErrorMessage = "Invalid First Name.")]
        public string FirstName { get; set; }
        [NopResourceDisplayName("Account.Fields.LastName")]
        [AllowHtml]
        [RegularExpression(@"^([A-Za-z ]{0,20})$", ErrorMessage = "Invalid Last Name.")]
        public string LastName { get; set; }

        //Changes related to vendor registration  08/01/2019 Start
        [NopResourceDisplayName("Account.Fields.Category")]
        [AllowHtml]
        public string Category { get; set; }
        //Changes related to vendor registration  08/01/2019 END
        ...
        [AllowHtml]
        [RegularExpression(@"^([A-Za-z ]{0,20})$", ErrorMessage = "Invalid City.")]
